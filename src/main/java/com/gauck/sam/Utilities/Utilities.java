...
public final class Utilities {
    ...
    private static Set<String> profaneWords = new HashSet<>(Arrays.asList(
            "anal", "analsex", "arsehole", "ass", "assbagger", "assblaster", "assclown", "asscowboy",
            "asses", "assfuck", "assfucker", "asshat", "asshole", "asshole", "assholes", "asshore",
            "assjockey", "asskiss", "asskisser", "assklown", "asslick", "asslicker", "asslover",
            "assman", "asspacker", "asspirate", "asspuppies", "assranger", "asswhore", "asswipe",
            "badfuck", "bastard", "bastards", "bigbutt", "bitch", "bitcher", "bitches", "bitchez",
            "bitchin", "bitching", "bitchslap", "bitchtits", "bitchy", "blowjob",
            "bollocks", "boner", "boob", "boobies", "boobs", "booby", "bootycall",
            "breastjob", "breastlover", "bullshit", "bumblefuck", "bumfuck", "bunghole", "butt",
            "butt-bang", "butt-fuck", "butt-fucker", "butt-fuckers", "buttbang", "buttface", "buttfuck",
            "buttfucker", "buttfuckers", "butthead", "buttman", "buttmunch", "buttmuncher", "buttpirate",
            "buttplug", "chickslick", "cock", "cock", "cockblock", "cockblocker",
            "cockcowboy", "cockfight", "cockhead", "cockknob", "cocklicker", "cocklover",
            "cocknob", "cocknose", "cockqueen", "cockrider", "cocksman", "cocksmith",
            "cocksmoker", "cocksucer", "cocksuck", "cocksucked", "cocksucker", "cocksucking",
            "cocktease", "cocky", "crack-whore", "crackwhore", "crap", "crap",
            "crotchjockey", "cum", "cumbubble", "cumfest", "cumjockey", "cumm",
            "cummer", "cumming", "cumquat", "cumqueen", "cumshot", "cuntfucker", "cuntlick", "cuntlicker",
            "cuntlicking", "cuntsucker", "cybersex", "dammit", "damn", "deepthroat", "dick",
            "dick", "dickbrain", "dickforbrains", "dickhead", "dickhead", "dickless",
            "dicklick", "dicklicker", "dickman", "dickwad", "dickweed", "dickweed",
            "dildo", "doggiestyle", "doggystyle", "douche", "dripdick", "dumbass", "dumbbitch",
            "dumbfuck", "ejaculate", "ejaculated", "ejaculating", "ejaculation", "facefucker",
            "fag", "fagot", "fannyfucker", "fastfuck", "fatass", "fatfuck", "fatfucker",
            "fingerfuck", "fingerfucked", "fingerfucker", "fingerfuckers", "fingerfucking",
            "fistfuck", "fistfucked", "fistfucker", "fistfucking", "footfuck", "footfucker",
            "footlicker", "foursome", "freakfuck", "freakyfucker", "freefuck", "fuck", "fucka",
            "fuckable", "fuckbag", "fuckbuddy", "fucked", "fuckedup", "fucker", "fucker",
            "fuckers", "fuckface", "fuckfest", "fuckfreak", "fuckfriend", "fuckhead", "fuckher",
            "fuckin", "fuckina", "fucking", "fuckingbitch", "fuckinnuts", "fuckinright", "fuckit",
            "fuckknob", "fuckme", "fuckmehard", "fuckmonkey", "fuckoff", "fuckpig", "fucks",
            "fucktard", "fuckwhore", "fuckyou", "gangbang", "gangbanged", "gangbanger", "gaysex",
            "handjob", "headfuck", "jackass", "jackoff", "jackshit", "jerkoff", "kkk", "livesex",
            ...
            "motherfucker", "motherfuckin", "motherfucking", "motherfuckings", "nigga", "niggah", "penises",
            "piss", "pissed", "pornflick", "pornking", "porno", "pornprincess", "pussy", "pusy",
            "sexed", "sexfarm", "sexhound", "sexhouse", "sexing", "sexkitten", "sexpot", "sexslave",
            "sextogo", "sexwhore", "sexy", "sexy-slim", "sexymoma", "shit", "shitflap", "slut",
            "slutt", "slutting", "slutty", "slutwear", "slutwhore", "tit", "vagina", "vaginal",
            "vibrator", "whore", "xxx"));
}
